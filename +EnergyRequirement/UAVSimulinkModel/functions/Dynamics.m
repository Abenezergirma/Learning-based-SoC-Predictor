...
function setup(block)
  ...
  block.OutputPort(15).Dimensions       = 3;
...
function DoPostPropSetup(block)
  ...
  block.Dwork(2).Name            = 'Forces';
  block.Dwork(2).Dimensions      = 3;
  block.Dwork(2).DatatypeID      = 0;      % double
  block.Dwork(2).Complexity      = 'Real'; % real
  
  block.Dwork(3).Name            = 'Torques';
...
block.OutputPort(14).Data  = block.Dwork(2).Data;
block.OutputPort(15).Data  = block.Dwork(3).Data;
...
Ftot_b=R_b_e'*[0 ;0; -m_t*model.g]+[0; 0; T_total]; % Total Force acting on the body 
vdot_b=[0 ;0; -model.g]+R_b_e*[0; 0; T_total/m_t]; % Linear Acceleration in the inertial frame
dU=vdot_b(1); 
dV=vdot_b(2); 
dW=vdot_b(3);
...
block.Dwork(2).Data=Ftot_b;
block.Dwork(3).Data=[Tau_x Tau_y Tau_z];
